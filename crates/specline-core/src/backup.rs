...
//! recording why, because the alternative was lived with for eight phases. Specline
...
mod tests {
    ...
    fn seeded(path: &Path) -> Store {
        ...
        conn.execute_batch(
            "INSERT INTO projects
             ...
             VALUES ('prj_1','specline','KEEL','Specline','k1','2026-08-11T00:00:00.000000Z',
    ...
    /// A directory that is not a Specline backup must say so, and say what to do.

...
//!
//! The real model lives in `specline-embed`, not here, and the reason is the
//! contract at the top of `specline-core`: this crate never opens a network socket.
...
//! linking `specline-core` dragged in the ONNX Runtime C++ dependency to get it,
...
//! can assert anything is a test suite people stop running. Design: `specline-core`

...
mod tests {
    ...
    fn the_shapes_match_the_apps_routes() {
        assert_eq!(
            task("http://127.0.0.1:7654", "keel", "KEEL-42"),
            "http://127.0.0.1:7654/#/projects/keel/tasks/KEEL-42"
        );
        assert_eq!(
            document("http://127.0.0.1:7654", "keel", "spc_01H8"),
            "http://127.0.0.1:7654/#/projects/keel/documents/spc_01H8"
        );
        assert_eq!(
            project("http://127.0.0.1:7654", "keel"),
            "http://127.0.0.1:7654/#/projects/keel"
        );
    }

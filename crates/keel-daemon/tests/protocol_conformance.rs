...
//!
//! Everything else in this suite asserts on Keel: what a tool returns, what a
...
async fn the_error_codes_are_the_ones_the_specification_names() {
    ...
    // Arguments that are the wrong shape. Keel answers these in the envelope
...
/// `tools/list` is a shape a client parses before it knows anything about Keel.
#[tokio::test]

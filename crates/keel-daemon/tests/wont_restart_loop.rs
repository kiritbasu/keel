...
fn an_unopenable_store_exits_zero_and_says_why() {
    ...
    let output = Command::new(env!("CARGO_BIN_EXE_keel-daemon"))
        .arg("--home")
        .arg(home.path())
        ...
        .env("RUST_LOG", "keel_daemon=error")
        .output()
